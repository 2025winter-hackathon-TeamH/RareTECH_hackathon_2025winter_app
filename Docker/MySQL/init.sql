...
VALUES 
  ...
  ('Team_H',  'teamh_0218_H@example.com', '937e8d5fbb48bd4949536cd65b8d35c426b80d2f830c5c308e2cdec422ae2244');
/*
...
VALUES 
  ('11月中に旅行に行く', '2025-09-03 01:03:24', '2025-11-30 00:00:00', 'give_up', 1),
  ('７月までに１つ資格を取る', '2026-01-01 07:34:29', '2026-06-30 00:00:00', NULL, 1),
  ('ハッカソン入門コース完走', '2026-01-04 00:00:00', '2026-02-28 00:00:00', NULL, 2),
  ('週2回MTGをする', '2026-01-03 00:00:00', '2026-02-23 00:00:00', 'achievement', 2),
  ('1時までに寝る', '2026-01-02 00:00:00', '2026-02-22 00:00:00', 'give_up', 2);
/*
...
VALUES 
  ...
  ('熱海と伊豆と出雲……悩ましい……北海道も良い', '2025-09-20 22:40:02', 1, 1),
  ('さっそく資格試験に申し込んだ！', '2026-01-04 21:06:09', 2, 1),
  ('テキスト10/980P読了完了。先はなが～い……', '2026-01-06 23:10:09', 2, 1),
  ('フロントエンドのhtmlページ作成完了', '2026-02-13 01:00:00', 3, 2),
  ('バックエンド機能作成完了', '2026-02-15 02:00:00', 3, 2),
  ('フロントエンドとバックエンドのドッキング完了', '2026-02-21 02:00:00', 3, 2),
  ('顔合わせ＆担当決め完了', '2026-01-4 23:00:00', 4, 2),
  ('暫定ペルソナ決め完了', '2026-01-11 01:30:00', 4, 2),
  ('初手から無理だった……！次リベンジ', '2026-01-04 02:00:00', 5, 2),
  ('今日こそと思ったけど……', '2026-01-06 02:00:00', 5, 2);
/*
...
VALUES 
  /* user1_goal_post_reaction_countup */
  (1, 3, NULL, 1), 
  (1, 3, NULL, 2),
  (1, 4, NULL, 1),
  (1, 4, NULL, 1),
  (1, 5, NULL, 2),
  /* user1_progress_post_reaction_countup */
  (1, 3, 5, 3), 
  (1, 3, 6, 4),
  (1, 3, 7, 3), 
  (1, 3, 5, 4),
  ...
  (1, 5, 10, 3),
  (1, 5, 11, 4),
  /* user2_goal_post_reaction_countup */
  (2, 1, NULL, 1), 
  (2, 1, NULL, 2),
  (2, 1, NULL, 1),
  (2, 2, NULL, 1),
  (2, 2, NULL, 2),
  /* user2_progress_post_reaction_countup */
  (2, 1, 1, 1), 
  (2, 1, 2, 2),
  (2, 1, 1, 3), 
  (2, 1, 2, 4),
